...
namespace SJH { class Framebuffer; class Program; class DirLight; class PointLight; class SpotLight; }
...
namespace SJH
{
    ...
    ///      - RenderContext::BeginFrame(target) + Actor 트리 MeshRenderer 수집 + Queue Flush
    ///
    class RenderSystem
    {
    public:
