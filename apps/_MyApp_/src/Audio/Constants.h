 ...
 *  nullptr(@c ERR_EVENT_NOTFOUND) 를 돌려주므로 (FMODAPI.md sec.5/sec.11), 분산된 문자열 리터럴 대신
...
namespace TopdownShooter::Audio
{
	...
	// getEvent 는 오타 시 조용히 nullptr(ERR_EVENT_NOTFOUND) 를 돌려주므로(FMODAPI.md sec.5/sec.11),
